...
[ML Config](../mlops_awesome_project/assets/README.md)  guides to make changes to ML code or deployed jobs.
...
```
git add README.md docs .gitignore mlops_awesome_project/assets/README.md
...
If you want to use different catalog names, please update the targets declared in the [mlops-awesome-project/databricks.yml](../mlops_awesome_project/databricks.yml)
and [mlops-awesome-project/assets/ml-artifacts-asset.yml](../mlops_awesome_project/assets/ml-artifacts-asset.yml)
 files. 
...
Follow the instructions in [mlops-awesome-project/assets/README.md](../mlops_awesome_project/assets/README.md) to deploy ML assets
and production jobs.
...
[ML pull request guide](ml-pull-request.md) and [ML asset config guide](../mlops_awesome_project/assets/README.md)  to propose, test, and deploy
