...
# ``mlops_awesome_project/assets/model-workflow-asset.yml``
#
# Parameters:
...
dbutils.widgets.text(
    "experiment_name",
    f"/dev-mlops-awesome-project-experiment",
    label="MLflow experiment name",
)
# Unity Catalog registered model name to use for the trained model.
dbutils.widgets.text(
    "model_name", "dev.awesome_mlops_schema.mlops-awesome-project-model", label="Full (Three-Level) Model Name"
)
