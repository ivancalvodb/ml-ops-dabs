...
#
# It runs as part of CD and by an automated model training job -> validation -> deployment job defined under ``mlops_awesome_project/assets/model-workflow-asset.yml``
#
#
# Parameters:
#
...
# * custom_metrics_loader_function          - Specifies the name of the function in mlops-awesome-project/validation/validation.py that returns custom metrics.
# * validation_thresholds_loader_function   - Specifies the name of the function in mlops-awesome-project/validation/validation.py that returns model validation thresholds.
#
...
dbutils.widgets.text(
    "experiment_name",
    "/dev-mlops-awesome-project-experiment",
    "Experiment Name",
)
...
dbutils.widgets.text("model_name", "dev.awesome_mlops_schema.mlops-awesome-project-model", "Full (Three-Level) Model Name")
